...
#ifndef JNI_WEBRTC_API_RTC_SESSION_DESCRIPTION_H_
#define JNI_WEBRTC_API_RTC_SESSION_DESCRIPTION_H_
...
namespace jni
{
	...
	{
		class JavaRTCSessionDescriptionClass : public JavaClass
		{
			public:
				explicit JavaRTCSessionDescriptionClass(JNIEnv * env);
