...
#ifndef JNI_WEBRTC_API_RTC_ANSWER_OPTIONS_H_
#define JNI_WEBRTC_API_RTC_ANSWER_OPTIONS_H_
...
namespace jni
{
	...
	{
		class JavaRTCAnswerOptionsClass : public JavaClass
		{
			public:
				explicit JavaRTCAnswerOptionsClass(JNIEnv * env);
