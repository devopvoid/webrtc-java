...
namespace jni::RTCRtpEncodingParameters
{
    JavaLocalRef<jobject> toJava(JNIEnv* env, const webrtc::RtpEncodingParameters& parameters)
    {
        ...
        {
            env->SetObjectField(object, javaClass->minBitrate,
                                Integer::create(env, parameters.min_bitrate_bps.value()));
        }
        if (parameters.max_bitrate_bps.has_value())
        {
            env->SetObjectField(object, javaClass->maxBitrate,
                                Integer::create(env, parameters.max_bitrate_bps.value()));
        }
        ...
        {
            env->SetObjectField(object, javaClass->scaleResolution,
                                Double::create(env, parameters.scale_resolution_down_by.value()));
        }
