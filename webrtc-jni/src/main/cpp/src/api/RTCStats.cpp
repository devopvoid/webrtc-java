...
namespace jni::RTCStats
{
    ...
    JavaLocalRef<jobject> toJava(JNIEnv* env, const webrtc::RTCStats& stats)
    {
        ...
        {
            type = JavaEnums::toJava(env, static_cast<RTCStatsType>(result->second));
        }
        else
        {
        ...
        jobject obj = env->NewObject(javaClass->cls, javaClass->ctor,
                                     ...
                                     static_cast<JavaLocalRef<jobject>>(memberMap).get());
    ...
    JavaLocalRef<jobject> toJava(JNIEnv* env, const webrtc::RTCStatsMemberInterface& member)
    {
        ...
        case webrtc::RTCStatsMemberInterface::kString:
            return jni::static_java_ref_cast<jobject>(env,
                                                      JavaString::toJava(
                                                          env, *member.cast_to<webrtc::RTCStatsMember<std::string>>()));

        case webrtc::RTCStatsMemberInterface::kSequenceBool:
            return jni::static_java_ref_cast<jobject>(env,
                                                      Boolean::createArray(
                                                          env, *member.cast_to<webrtc::RTCStatsMember<std::vector<
                                                              bool>>>()));
        ...
        case webrtc::RTCStatsMemberInterface::kSequenceUint32:
            {
                ...
                return jni::static_java_ref_cast<jobject>(env,
                                                          Long::createArray(
                                                              env, std::vector<int64_t>(v.begin(), v.end())));
            }
        ...
        case webrtc::RTCStatsMemberInterface::kSequenceString:
            return jni::static_java_ref_cast<jobject>(env,
                                                      JavaString::createArray(
                                                          env, *member.cast_to<webrtc::RTCStatsMember<std::vector<
                                                              std::string>>>()));

        case webrtc::RTCStatsMemberInterface::kMapStringDouble:
            {
                std::map<std::string, double> map = *member.cast_to<webrtc::RTCStatsMember<std::map<
                    std::string, double>>>();
        ...
        case webrtc::RTCStatsMemberInterface::kMapStringUint64:
            {
                std::map<std::string, uint64_t> map = *member.cast_to<webrtc::RTCStatsMember<std::map<
                    std::string, uint64_t>>>();
