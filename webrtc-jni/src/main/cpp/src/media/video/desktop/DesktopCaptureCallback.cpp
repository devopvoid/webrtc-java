...
namespace jni
{
    ...
    void DesktopCaptureCallback::OnCaptureResult(webrtc::DesktopCapturer::Result result,
                                                 std::unique_ptr<webrtc::DesktopFrame> frame)
    {
        ...
        jint rotation = webrtc::kVideoRotation_0;
    ...
    DesktopCaptureCallback::JavaDesktopCaptureCallbackClass::JavaDesktopCaptureCallbackClass(JNIEnv* env)
    {
        ...
        onCaptureResult = GetMethod(env, cls, "onCaptureResult",
                                    "(L" PKG_DESKTOP "DesktopCapturer$Result;L" PKG_VIDEO "VideoFrame;)V");
    }
}
