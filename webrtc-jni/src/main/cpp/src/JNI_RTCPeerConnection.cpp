...
(JNIEnv* env, jobject caller, jobject jTrack, jobject jStreamIds)
{
    ...
    std::vector<std::string> streamIDs =
        jni::JavaList::toStringVector(env, jni::JavaLocalRef<jobject>(env, jStreamIds));
...
(JNIEnv* env, jobject caller, jobject jOptions, jobject jObserver)
{
    ...
    try
    {
        ...
        auto observer = new rtc::RefCountedObject<jni::CreateSessionDescriptionObserver>(
...
(JNIEnv* env, jobject caller, jobject jSessionDesc, jobject jobserver)
{
    ...
    try
    {
        ...
        auto observer = new rtc::RefCountedObject<jni::SetSessionDescriptionObserver>(
            env, jni::JavaGlobalRef<jobject>(env, jobserver));
...
(JNIEnv* env, jobject caller, jobject jCandidates)
{
    ...
    try
    {
        auto candidates = jni::JavaArray::toNativeVector<cricket::Candidate>(env,
                                                                             jni::static_java_ref_cast<jobjectArray>(
                                                                                 env, jni::JavaLocalRef<jobject>(
                                                                                     env, jCandidates)),
...
{
    webrtc::PeerConnectionInterface* pc = GetHandle<webrtc::PeerConnectionInterface>(env, caller);
    CHECK_HANDLE_DEFAULT(
        pc, jni::JavaEnums::toJava(env, webrtc::PeerConnectionInterface::SignalingState::kClosed).release());
...
(JNIEnv* env, jobject caller)
{
    webrtc::PeerConnectionInterface* pc = GetHandle<webrtc::PeerConnectionInterface>(env, caller);
    CHECK_HANDLE_DEFAULT(
        pc, jni::JavaEnums::toJava(env, webrtc::PeerConnectionInterface::IceGatheringState::kIceGatheringNew).release())
    ;
...
(JNIEnv* env, jobject caller)
{
    webrtc::PeerConnectionInterface* pc = GetHandle<webrtc::PeerConnectionInterface>(env, caller);
    CHECK_HANDLE_DEFAULT(
        pc, jni::JavaEnums::toJava(env, webrtc::PeerConnectionInterface::IceConnectionState::kIceConnectionClosed).
        release());
...
(JNIEnv* env, jobject caller)
{
    webrtc::PeerConnectionInterface* pc = GetHandle<webrtc::PeerConnectionInterface>(env, caller);
    CHECK_HANDLE_DEFAULT(
        pc, jni::JavaEnums::toJava(env, webrtc::PeerConnectionInterface::PeerConnectionState::kClosed).release());
...
(JNIEnv* env, jobject caller, jobject jcallback)
{
    ...
    auto callback = new rtc::RefCountedObject<jni::RTCStatsCollectorCallback>(
        env, jni::JavaGlobalRef<jobject>(env, jcallback));

    pc->GetStats(callback);
}

JNIEXPORT void JNICALL
Java_dev_onvoid_webrtc_RTCPeerConnection_getStats__Ldev_onvoid_webrtc_RTCRtpReceiver_2Ldev_onvoid_webrtc_RTCStatsCollectorCallback_2
...
JNIEXPORT void JNICALL
Java_dev_onvoid_webrtc_RTCPeerConnection_getStats__Ldev_onvoid_webrtc_RTCRtpSender_2Ldev_onvoid_webrtc_RTCStatsCollectorCallback_2
