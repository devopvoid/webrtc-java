...
#ifndef JNI_WEBRTC_MEDIA_AVF_VIDEO_DEVICE_MANAGER_H_
#define JNI_WEBRTC_MEDIA_AVF_VIDEO_DEVICE_MANAGER_H_
...
namespace jni
{
	namespace avdev
	{
		class AVFVideoDeviceManager : public VideoDeviceManager
		{
			public:
				AVFVideoDeviceManager();
				~AVFVideoDeviceManager();
			...
			private:
				...
				webrtc::VideoType toVideoType(const std::uint32_t & fourCC);
