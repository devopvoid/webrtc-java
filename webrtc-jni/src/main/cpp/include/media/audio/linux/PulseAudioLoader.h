...
namespace jni 
{
    namespace avdev 
    {
        ...
        typedef pa_context * ( * pa_context_new_t)(pa_mainloop_api * mainloop,
            const char * name);
        ...
        typedef int( * pa_context_connect_t)(pa_context * c,
            const char * server, pa_context_flags_t flags,
        ...
        typedef pa_operation * ( * pa_context_get_source_info_by_name_t)(pa_context * c,
        ...
        typedef pa_operation * ( * pa_context_get_sink_info_by_name_t)(pa_context * c,
        ...
        typedef
        const char * ( * pa_proplist_gets_t)(const pa_proplist * p,
            const char * key);

        class PulseAudioLoader {
            public: static PulseAudioLoader & instance() {
            ...
            private: PulseAudioLoader(): loaded(false),
            lib_handle(nullptr) {}
            bool loaded;
            void * lib_handle;
        };
